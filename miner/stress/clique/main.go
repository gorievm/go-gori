...
func makeSealer(genesis *core.Genesis) (*node.Node, *eth.Ori, error) {
	// Define the basic configurations for the Ori node
	...
	// Start the node and configure a full Ori node on it
