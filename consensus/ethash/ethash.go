...
// all blocks' seal as valid, though they still have to conform to the Ori
// consensus rules.
...
// still have to conform to the Ori consensus rules.
...
// they still have to conform to the Ori consensus rules.
