...
// all blocks' seal as valid, though they still have to conform to the Gori
// consensus rules.
...
// still have to conform to the Gori consensus rules.
...
// they still have to conform to the Gori consensus rules.
