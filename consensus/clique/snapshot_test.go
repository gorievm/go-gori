...
// mapped from textual names used in the tests below to actual Gori private
...
// address retrieves the Gori address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Gori address
	...
	tests := []cliqueTest{
		{
			...
			// batch (https://github.com/gorievm/go-gori/issues/17593). Whilst this
