...
// mapped from textual names used in the tests below to actual Ori private
...
// address retrieves the Ori address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Ori address
