...
// ecrecover extracts the Gori account address from a signed header.
func ecrecover(header *types.Header, sigcache *sigLRU) (common.Address, error) {
	...
	// Recover the public key and the Gori address
...
// Gori testnet following the Ropsten attacks.
type Clique struct {
	...
	signer common.Address // Gori address of the signing key
...
// Author implements consensus.Engine, returning the Gori address recovered
