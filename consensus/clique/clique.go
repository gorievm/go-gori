...
import (
	...
	lru "github.com/gorievm/go-gori/common/lru"
...
// ecrecover extracts the Ori account address from a signed header.
func ecrecover(header *types.Header, sigcache *sigLRU) (common.Address, error) {
	...
	// Recover the public key and the Ori address
...
// Ori testnet following the Ropsten attacks.
type Clique struct {
	...
	signer common.Address // Ori address of the signing key
...
// Author implements consensus.Engine, returning the Ori address recovered
