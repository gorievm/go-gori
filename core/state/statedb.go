...
// Package state provides a caching layer atop the Gori state trie.
package state
...
import (
	...
	"github.com/gorievm/go-gori/trie/triestate"
	"github.com/gorievm/go-gori/trie/utils"
...
func (s *StateDB) StartPrefetcher(namespace string, witness *stateless.Witness) {
	...
	if s.snap != nil {
		...
		// https://github.com/gorievm/go-gori/issues/29880
...
func (s *StateDB) IntermediateRoot(deleteEmptyObjects bool) common.Hash {
	...
	if s.db.TrieDB().IsVerkle() {
		...
		// for all the accounts and all the storage slots merged togorier. The
