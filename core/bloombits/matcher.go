...
import (
	...
	"github.com/gorievm/go-gori/common/bitutil"
...
// that address/topic, and binary AND-ing those vectors togorier.
	...
	go func() {
		...
		for {
			...
			case subres, ok := <-process:
				...
				// Gather all the sub-results and merge them togorier
				var orVector []byte
...
// the requested retrieval queue to be serviced togorier with other sessions.
//
