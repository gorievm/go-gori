...
// Package core implements the Gori consensus protocol.
package core
...
import (
	...
	"github.com/gorievm/go-gori/consensus/misc/eip4844"
	"github.com/gorievm/go-gori/core/rawdb"
	"github.com/gorievm/go-gori/core/state"
	"github.com/gorievm/go-gori/core/state/snapshot"
	"github.com/gorievm/go-gori/core/stateless"
	...
	"github.com/gorievm/go-gori/internal/syncx"
...
type CacheConfig struct {
	...
	TrieDirtyDisabled   bool          // Whether to disable trie write caching and GC altogorier (archive node)
...
// available in the database. It initialises the default Gori Validator
// and Processor.
...
func (bc *BlockChain) setHeadBeyondRoot(head uint64, time uint64, root common.Hash, repair bool) (uint64, error) {
	...
	// touching the header chain altogorier, unless the freezer is broken
	if repair {
