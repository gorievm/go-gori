...
// Package types contains data types related to Gori consensus.
package types
...
// Header represents a block header in the Gori blockchain.
type Header struct {
...
// a block's data contents (transactions and uncles) togorier.
type Body struct {
