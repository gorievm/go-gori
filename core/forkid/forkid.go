...
// timestampThreshold is the Gori mainnet genesis timestamp. It is used to
...
// NewID calculates the Gori fork ID from the chain config, genesis hash, head and time.
...
// NewIDWithChain calculates the Gori fork ID from an existing chain instance.
