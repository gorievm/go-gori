...
// timestampThreshold is the Ori mainnet genesis timestamp. It is used to
...
// NewID calculates the Ori fork ID from the chain config, genesis hash, head and time.
...
// NewIDWithChain calculates the Ori fork ID from an existing chain instance.
