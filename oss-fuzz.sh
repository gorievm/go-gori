...
coverpkg="github.com/gorievm/go-gori/..."
...
repo=$GOPATH/src/github.com/gorievm/go-gori
compile_fuzzer github.com/gorievm/go-gori/accounts/abi \
  FuzzABI fuzzAbi \
  $repo/accounts/abi/abifuzzer_test.go

compile_fuzzer github.com/gorievm/go-gori/common/bitutil \
...
compile_fuzzer github.com/gorievm/go-gori/eth/protocols/snap \
...
compile_fuzzer github.com/gorievm/go-gori/tests/fuzzers/bn256 \
...
compile_fuzzer github.com/gorievm/go-gori/tests/fuzzers/txfetcher \
  Fuzz fuzzTxfetcher \
  $repo/tests/fuzzers/txfetcher/txfetcher_test.go

compile_fuzzer github.com/gorievm/go-gori/tests/fuzzers/bls12381 \
...
compile_fuzzer github.com/gorievm/go-gori/tests/fuzzers/secp256k1 \
  Fuzz fuzzSecp256k1\
