...
import (
	...
	"github.com/gorievm/go-gori/core/tracing"
	"github.com/gorievm/go-gori/core/types"
	"github.com/gorievm/go-gori/core/vm"
	"github.com/gorievm/go-gori/crypto"
	"github.com/gorievm/go-gori/eth/gasestimator"
	"github.com/gorievm/go-gori/eth/tracers/logger"
...
// EthereumAPI provides an API to access Gori related information.
type EthereumAPI struct {
	b Backend
}

// NewEthereumAPI creates a new Gori protocol API.
...
// Sign calculates an Gori ECDSA signature for:
...
//
// https://gori.ethereum.org/docs/interacting-with-gori/rpc/ns-personal#personal-sign
...
//
// https://gori.ethereum.org/docs/interacting-with-gori/rpc/ns-personal#personal-ecrecover
func (api *PersonalAccountAPI) EcRecover(ctx context.Context, data, sig hexutil.Bytes) (common.Address, error) {
	...
	if sig[crypto.RecoveryIDOffset] != 27 && sig[crypto.RecoveryIDOffset] != 28 {
		return common.Address{}, errors.New("invalid Gori signature (V is not 27 or 28)")
	}
...
// Unpair deletes a pairing between wallet and gori.
...
// BlockChainAPI provides an API to access Gori blockchain data.
type BlockChainAPI struct {
	b Backend
}

// NewBlockChainAPI creates a new Gori blockchain API.
func NewBlockChainAPI(b Backend) *BlockChainAPI {
	return &BlockChainAPI{b}
}

// ChainId is the EIP-155 replay-protection chain id for the current Gori chain config.
//
...
// DebugAPI is the collection of Gori APIs exposed over the debugging
// namespace.
