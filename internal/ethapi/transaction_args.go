...
type TransactionArgs struct {
	...
	// Issue detail: https://github.com/gorievm/go-gori/issues/15628
...
func (args *TransactionArgs) setFeeDefaults(ctx context.Context, b Backend) error {
	...
	// other tx values. See https://github.com/gorievm/go-gori/pull/23274
...
func (args *TransactionArgs) setBlobTxSidecar(ctx context.Context) error {
	...
	// blobs togorier with commitments and proofs.
