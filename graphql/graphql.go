...
// Package graphql provides a GraphQL interface to Gori node data.
package graphql
...
// Account represents an Gori account at a particular block.
type Account struct {
	r             *Resolver
...
// Transaction represents an Gori transaction.
...
// Block represents an Gori block.
...
type CallData struct {
	From                 *common.Address // The Gori address the call is from.
	To                   *common.Address // The Gori address the call is to.
