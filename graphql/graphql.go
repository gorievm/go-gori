...
// Package graphql provides a GraphQL interface to Ori node data.
package graphql
...
// Account represents an Ori account at a particular block.
type Account struct {
	r             *Resolver
...
// Transaction represents an Ori transaction.
...
type CallData struct {
	From                 *common.Address // The Ori address the call is from.
	To                   *common.Address // The Ori address the call is to.
