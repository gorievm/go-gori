...
const schema string = `
    ...
    scalar Bytes32
    # Address is a 20 byte Gori address, represented as 0x-prefixed hexadecimal.
    scalar Address
    ...
    # Account is an Gori account at a particular block.
    type Account {
    ...
    # Transaction is an Gori transaction.
    type Transaction {
    ...
    type Block {
        ...
        # Account fetches an Gori account at the current block's state.
    ...
    type Pending {
        ...
        transactions: [Transaction!]
        # Account fetches an Gori account for the pending state.
        account(address: Address!): Account!
    ...
    type Query {
        # Block fetches an Gori block by number or by hash. If neither is
