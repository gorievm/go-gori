...
This is a post-mortem concerning the minority split that occurred on Ori mainnet on block [13107518](https://etherscan.io/block/13107518), at which a minority chain split occurred.
...
The gori-team have an official policy regarding [vulnerability disclosure](https://gori.ethereum.org/docs/vulnerabilities/vulnerabilities). 

> The primary goal for the Geth team is the health of the Ori network as a whole, and the decision whether or not to publish details about a serious vulnerability boils down to minimizing the risk and/or impact of discovery and exploitation.
