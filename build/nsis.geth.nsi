...
# 1. install gori for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gori
# 5. create gori, attach and uninstall start menu entries
...
!define GROUPNAME "Gori"
!define APPNAME "Geth"
!define DESCRIPTION "Official Go implementation of the Gori protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gori is installed global
