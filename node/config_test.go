...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gori.ipc", false, filepath.Join(os.TempDir(), "gori.ipc")},
		{"data", "gori.ipc", false, "data/gori.ipc"},
		{"data", "./gori.ipc", false, "./gori.ipc"},
		{"data", "/gori.ipc", false, "/gori.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gori.ipc", true, `\\.\pipe\gori.ipc`},
		{"data", "gori.ipc", true, `\\.\pipe\gori.ipc`},
		{"data", `\\.\pipe\gori.ipc`, true, `\\.\pipe\gori.ipc`},
	}
