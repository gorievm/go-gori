...
// valid Gori transaction.
type TransactOpts struct {
	From   common.Address // Gori account to send the transaction from
...
// Gori network. It contains a collection of methods that are used by the
// higher level contract bindings to operate.
type BoundContract struct {
	address    common.Address     // Deployment address of the contract on the Gori blockchain
	abi        abi.ABI            // Reflect based ABI to access the correct Gori methods
...
// DeployContract deploys a contract onto the Gori blockchain and binds the
