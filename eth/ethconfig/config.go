...
// Defaults contains default settings for use on the Gori main net.
var Defaults = Config{
...
type Config struct {
	...
	// If nil, the Gori main net block is used.
	...
	// canonical chain of all remote peers. Setting the option makes gori verify the
