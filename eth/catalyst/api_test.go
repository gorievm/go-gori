...
var (
	...
	// testAddr is the Gori address of the tester account.
...
func startEthService(t *testing.T, genesis *core.Genesis, blocks []*types.Block) (*node.Node, *eth.Gori) {
	t.Helper()
...
func setupBlocks(t *testing.T, ethservice *eth.Gori, n int, parent *types.Header, callback func(parent *types.Header), withdrawals [][]*types.Withdrawal) []*types.Header {
	api := NewConsensusAPI(ethservice)
...
func setupBodies(t *testing.T) (*node.Node, *eth.Gori, []*types.Block) {
	genesis, blocks := generateMergeChain(10, true)
