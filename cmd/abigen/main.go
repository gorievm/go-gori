...
var (
	...
	abiFlag = &cli.StringFlag{
		Name:  "abi",
		Usage: "Path to the Ori contract ABI json to bind, - for STDIN",
	}
	binFlag = &cli.StringFlag{
		Name:  "bin",
		Usage: "Path to the Ori contract bytecode (generate deploy method)",
	}
...
var app = flags.NewApp("Ori ABI wrapper code generator")
