		...
		Subcommands: []*cli.Command{
			{
				...
				Description: `
gori snapshot prune-state <state-root>
...
`,
			},
			{
				...
				Description: `
gori snapshot verify-state <state-root>
...
`,
			},
			{
				...
				Flags:     flags.Merge(utils.NetworkFlags, utils.DatabaseFlags),
				Description: `
gori snapshot check-dangling-storage <state-root> traverses the snap storage
...
`,
			},
			{
				...
				Flags:     flags.Merge(utils.NetworkFlags, utils.DatabaseFlags),
				Description: `
gori snapshot inspect-account <address | hash> checks all snapshot layers and prints out
...
`,
			},
			{
				...
				Flags:     flags.Merge(utils.NetworkFlags, utils.DatabaseFlags),
				Description: `
gori snapshot traverse-state <state-root>
...
`,
			},
			{
				...
				Flags:     flags.Merge(utils.NetworkFlags, utils.DatabaseFlags),
				Description: `
gori snapshot traverse-rawstate <state-root>
...
`,
			...
			{
				Name:      "dump",
				Usage:     "Dump a specific block from storage (same as 'gori dump' but using snapshots)",
				...
				Description: `
This command is semantically equivalent to 'gori dump', but uses the snapshots
