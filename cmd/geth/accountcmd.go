...
var (
	walletCommand = &cli.Command{
		Name:      "wallet",
		Usage:     "Manage Gori presale wallets",
		ArgsUsage: "",
		Description: `
    gori wallet import /path/to/my/presale.wallet
		...
		Subcommands: []*cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import Gori presale wallet",
				ArgsUsage: "<keyFile>",
				Action:    importWallet,
				Flags: []cli.Flag{
					utils.DataDirFlag,
				...
				Description: `
	gori wallet [options] /path/to/my/presale.wallet
...
For non-interactive use the password can be specified with the --password flag:
    ...
    gori account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    gori account import [options] <keyfile>
