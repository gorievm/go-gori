...
import (
	...
	"github.com/gorievm/go-gori/internal/jsre"
...
func newTester(t *testing.T, confOverride func(*ethconfig.Config)) *tester {
	...
	// Create a networkless protocol stack and start an Gori service within
	...
	if err != nil {
		t.Fatalf("failed to register Gori protocol: %v", err)
	}
