...
var (
	...
	// and accepted by the Ori core developers into the Ethash consensus.
	...
	// and accepted by the Ori core developers into the Clique consensus.
	...
	// and accepted by the Ori core developers for testing proposes.
